...
The following example clones the "[EPC4 TFM Attestation](https://github.com/Infineon/mtb-example-psoc-edge-epc4-tfm-attestation)" application with the desired name "Epc4TfmAttest" configured for the *KIT_PSE84_EVAL_EPC4* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC4 --app-id mtb-example-psoc-edge-epc4-tfm-attestation --user-app-name Epc4TfmAttest --target-dir "C:/mtb_projects"
   ```
