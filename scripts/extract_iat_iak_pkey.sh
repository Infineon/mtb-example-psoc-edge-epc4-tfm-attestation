...
${OPENOCD_PATH}/bin/openocd.exe -s ../scripts -f interface/kitprog3.cfg -f target/infineon/pse84xgxs4.cfg -c "init; reset init; dump_image ./Attestation_token.cbor 0x240fe000 1024; shutdown" &>openocd_logs.txt
...
edgeprotecttools set-ocd -n openocd -p ${OPENOCD_PATH} -c infineon/pse84xgxs4.cfg
